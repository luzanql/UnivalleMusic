            ...
            <div data-role="content" data-theme = "a">	
                <div class="ui-grid-b">
                    ...
                    <div class="ui-block-b" style="margin:3%">
                        ...
                        <div id="FichaCancion">
                            <form action="resultadoSubirCancion.php" method="post" data-ajax="false" enctype="multipart/form-data">
                                <label for="basic" data-mini="true">T&iacute;tulo:</label> <input type="text" name="titulo" id="titulo" value="" data-mini="true"  />
                                <label for="basic" data-mini="true">Artista:</label><input type="text" name="artista" id="artista" value=""  data-mini="true" />
