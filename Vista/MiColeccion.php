                            ...
                            <tr>
                                <td>
                                    <div data-role="controlgroup" data-type="horizontal" data-mini="true">
                                        <a href="subir_cancion.html" data-role="button" data-icon="plus" >Subir Cancion</a>
                                    </div>
                                </td>
                                <td>
                                    <fieldset data-role="controlgroup" data-type="horizontal">
                                        <select name="ordenar" id="ordenarPor" data-mini="true" >
                                            ...
                                            <option value="rock">T&iacute;tulo</option>
                                            <option value="clasica">&Aacute;lbum</option>
                                            <option value="romantica">Artista</option>
                                        </select>
                                    </fieldset>
                                </td>
